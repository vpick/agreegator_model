...
@section('title', 'Reverse Order View Card')
@section('content')
<!-- <header class="py-4">
                                ...
                                <div class="col-xl-12">
                                    <div class="row align-items-center gy-3 text-center mb-4">
                                        ...
                                        <div class="col-sm-6 text-sm-end">
                                            ...
                                            @endif
                                            <a @if($order->shipping_label !='') href="{{ $order->shipping_label }}" @endif class="btn btn-outline-dark btn-sm" ><i class="fa fa-print me-2"></i>Print Label</a>
                                            @if($order->order_status == 'Booked' && $order->status == '0')
                                                <a href="show-rorder?ord={{Crypt::encrypt($order->id)}}" class="btn btn-outline-dark btn-sm" >Edit</a>
                                            @else
                                        ...
                                        <ul class="dropdown-menu shadow-sm">
                                            <li><a class="dropdown-item" href="show-rorder?ordClone={{Crypt::encrypt($order->order_no)}}"><i class="mdi mdi-plus"></i> Clone Reverse Order</a></li>
