                    						...
                    						<div class="row">
                    							...
                    							<div class="form-group col-lg-3">
                    								...
                    								<select id="order_type" required="" name="order_type" class="form-control">
                    									<option value="B2C" {{ old('order_type') == 'B2C' ? 'selected' :'' }}>B2C</option>
                    									<option value="B2B" {{ old('order_type') == 'B2B' ? 'selected' :'' }}>B2B</option>
                    								</select>
                    								<span class="errormsg" id="errormsg" style="color: #8b0001;font-weight: bold;">
                    				...
                    				<div class="card m-b-30">
                    					...
                    					<div class="card-body ">
                    						...
                    						<div class="row">
                    							<div class="form-group col-sm-6">
                    								<label>Phone*</label>
                    								<input type="text" name="shipping_phone_number" onkeypress="return validateFloatKeyPress(this,event.key)" maxlength="10" minlength="10" id="shipping_phone" autocomplete="nope"  required="" class="form-control" placeholder="Phone" value="{{ old('shipping_phone') }}">
                    								<span class="errormsg" id="errormsg" style="color: #8b0001;font-weight: bold;">
                    							...
                    							<div class="form-group col-sm-6">
                    								...
                    								<input type="text" onkeypress="return validateFloatKeyPress(this,event.key)" maxlength="10" minlength="10" name="shipping_alternate_phone" id="shipping_phone_alternate" autocomplete="nope" pattern="[1-9]{1}[0-9]{9}" class="form-control" placeholder="Phone" value="{{ old('shipping_phone_alternate') }}">
                    								<span class="errormsg" id="errormsg" style="color: #8b0001;font-weight: bold;"></span>
                    							</div>
                    						</div>
                    						<div class="row">
                    							...
                    							<table class="table invoice-detail-table create-invoice com-create-sales-table product_det_table">
                    								...
                    								<tbody id="field_wrapper" class="product_table_tbody">
                    									<tr id="customerfield0">
                    										...
                    										<td>
                    											<input type="text" autocomplete="nope" id="productsku0" name="products[0][product_sku]" class="form-control" placeholder="SKU" value="{{ old('product_sku') }}" required="">
                    				...
                    				<div class="card m-b-30">
                    					<div class="card-body">
                    						...
                    						<div class="form-group col-sm-6">
                    							...
                    							<input type="text" onkeypress="return validateFloatKeyPress(this,event.key)" autocomplete="nope" name="cod_charges" id="cod_charges" required="" class="form-control" placeholder="COD Charges" value="{{ old('cod_charges') ? old('cod_charges') : 0 }}">
                    						</div>
                    						<div class="form-group col-sm-6">
                    						...
                    						<br />
                    						<button type="submit" name="submit" class="btn btn-primary" id="submitBtn">Save</button>&nbsp;
