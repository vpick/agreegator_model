        ...
        <div class="container-fluid">
          <div class="row">
			...
			<ul class="nav nav-tabs" id="myTab" role="tablist">
			  ...
			  <li class="nav-item" role="presentation">
				<button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile-tab-pane" type="button" role="tab" aria-controls="profile-tab-pane" aria-selected="false">Action Required</button>
			  </li>
			  <li class="nav-item" role="presentation">
				<button class="nav-link" id="contact-tab" data-bs-toggle="tab" data-bs-target="#contact-tab-pane" type="button" role="tab" aria-controls="contact-tab-pane" aria-selected="false">Action Pending - Shipper</button>
			  </li>
			  <li class="nav-item" role="presentation">
				<button class="nav-link" id="disabled-tab" data-bs-toggle="tab" data-bs-target="#dispatch-tab-pane" type="button" role="tab" aria-controls="disabled-tab-pane" aria-selected="false">Action Executed - Shipper</button>
			  </li>
			  <li class="nav-item" role="presentation">
			  ...
			  <li class="nav-item" role="presentation">
				<button class="nav-link" id="disabled-tab" data-bs-toggle="tab" data-bs-target="#delivered-tab-pane" type="button" role="tab" aria-controls="disabled-tab-pane" aria-selected="false">Delivered</button>
			  </li>
			  <li class="nav-item" role="presentation">
            ...
            <div class="tab-content" id="myTabContent">
			  ...
			  <tbody>
				<tr style='border-radius: 5px 5px 4px 5px;box-shadow: 1px 1px 1px 0px aqua;'>
				  ...
				  <td>
					<p class="fw-normal mb-1"><span class="badge text-bg-warning">Delivered</span></p>
				  </td>
				  <td>
					₹ 1860.00
				  </td>
				  <td>Xpress</td>
				  <td>
				   <button type="button" class="btn btn-outline-primary">See Journey</button>
				  </td>
				</tr>
				<tr style='border-radius: 5px 5px 4px 5px;box-shadow: 1px 1px 1px 0px aqua;'>
				  <td>
			  ...
			  <div class="tab-pane fade" id="<span class="badge text-bg-warning">Delivered</span>-tab-pane" role="tabpanel" aria-labelledby="disabled-tab" tabindex="0">
