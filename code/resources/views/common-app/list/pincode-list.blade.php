...
<section class="py-filter">
	<div class="col-md-12 text-right">
		...
		<a href=""><button type="button" class="btn btn-sm btn-outline-dark refresh_orders_button"><i class="mdi mdi-refresh"></i> Refresh</button></a>
	...
	<div id='filter' style='display:none'>
	    <div class="card-body">
			<form class="row g-3 align-items-center" method="GET" action="{{ route('pincode.get') }}">	
			<div class="row">
				...
				<div class="col-lg">
					...
					<a href="{{ route('pincode.get') }}" class="btn btn-secondary" style="margin-top: 25px;border-radius: 5px">Clear</a>
				</div>
			</div>
			</form>
		</div>
