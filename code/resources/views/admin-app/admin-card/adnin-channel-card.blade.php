	  ...
	  <div class="row">
		...
		<div class="col-lg-12">
			<div class="card">
				...
				@endif
				<div class="card-body">
				  <form class="row g-3 align-items-center" method="post" action="{{url('app-store-chanel')}}">
				    @csrf
					<div class="col-lg">
					  ...
					  <div class="input-group">
						...
						<input class="form-control" id="" name='chanel_name' type="text" placeholder="Chanel Name">
						</div>
						<p>
					...
					<div class="col-lg">
					  ...
					  <div class="input-group">
						<div class="input-group-text">*</div>
						  ...
						  <input class="form-control" value='' name='chanel_logo' id='chanel_logo' type="hidden" readonly>
					  </div>
					   <p>
