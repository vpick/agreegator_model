...
@section('content')
    <section class="py-filter">
		...
		<!--<button class="btn btn-outline-dark btn-sm dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">Create Aggregator</button>-->
	 <!--   <ul class="dropdown-menu shadow-sm">-->
		<!--	<li><a class="dropdown-item" href="/app-add-logistics"><i class="mdi mdi-plus"></i> Create Aggregator</a></li>-->
		<!--</ul>-->
