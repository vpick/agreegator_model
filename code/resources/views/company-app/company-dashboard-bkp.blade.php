  ...
  <div class="row d-flex align-items-md-stretch">
      ...
      <div class="card shadow-0">
        <div class="card-body p-0">
            <div class="bg-light p-3 shadow-sm">                 
              <a class="btn btn-xs btn-dark py-1 m-1" href="#!" ><i class="fas fa-thumbs-up me-1" ></i><span id="countDelivered">0</span> </a><a class="btn btn-xs btn-dark py-1 m-1" href="#!" ><i class="fas fa-heart me-1" > </i>Delivered Shipment</a>
    ...
    <div class="col-lg-3 col-md-6">
      <div class="card shadow-0">
        <div class="card-body p-0">
            <div class="bg-light p-3 shadow-sm">
                <a class="btn btn-xs btn-dark py-1 m-1" href="#!"><i class="fas fa-thumbs-up me-1"></i><span id="countRto">0</span></a><a class="btn btn-xs btn-dark py-1 m-1" href="#!"><i class="fas fa-heart me-1" > </i>RTO Shipment</a>
              <small class="text-gray-600"></small>
            </div>
        </div>
      </div>
    ...
    <div class="col-lg-3 col-md-6">
      <div class="card shadow-0">
        <div class="card-body p-0">
            <div class="bg-light p-3 shadow-sm">
                <a class="btn btn-xs btn-dark py-1 m-1" href="#!"><i class="fas fa-thumbs-up me-1"></i><span id="countPendingpick">0</span></a><a class="btn btn-xs btn-dark py-1 m-1" href="#!"><i class="fas fa-heart me-1"> </i>Peding Pickup Shipment</a>
              <small class="text-gray-600"></small>
            </div>
        </div>
      </div>
    ...
    <div class="col-lg-3 col-md-6">
      <div class="card shadow-0">
        <div class="card-body p-0">
            <div class="bg-light p-3 shadow-sm">
                <a class="btn btn-xs btn-dark py-1 m-1" href="#!"><i class="fas fa-thumbs-up me-1"></i><span id="countIntransit">0</span></a><a class="btn btn-xs btn-dark py-1 m-1" href="#!"><i class="fas fa-heart me-1" > </i>In Transit Shipment</a>
              <small class="text-gray-600"></small>
            </div>
        </div>
      </div>
  ...
  <div class="container-fluid">
    <div class="row align-items-stretch gy-4">
      ...
      <div class="col-lg-4">
        ...
        <div class="card h-100 mb-0">
          <div class="card-body">
            <h2 class="h3 fw-normal mb-4">Total Delivered Shipment COD vs Prepaid</h2>
            ...
            $.ajax({
              ...
              success: function(data) {
                ...
                record_months.forEach(recordElement => {
                    const monthNameValue = recordElement.month_name;
                    if (!monthName.includes(monthNameValue)) {
                        // Only push data if the month_name is not already in the array
                        monthName.push(monthNameValue);
