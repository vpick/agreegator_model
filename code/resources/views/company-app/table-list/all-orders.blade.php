        ...
        @endphp
	      ...
	      <!--    <li class="nav-item me-2" role="presentation">-->
    		 ...
    		 <!-- </li>-->
    		  ...
    		  <li class="nav-item me-2" role="presentation">
    			<a class="nav-link btn-css {{ $ord=='Out for Delivery' ? 'activeClass btn-black':'btn-white' }}" href="{{ url('/orders?ord=Out for Delivery') }}" id="contact-tab" data-bs-target="#contact-tab-pane" type="button" role="tab" aria-controls="contact-tab-pane" aria-selected="false">Out for Delivery (0)</a>
    		  </li>
    		  <li class="nav-item me-2" role="presentation">
